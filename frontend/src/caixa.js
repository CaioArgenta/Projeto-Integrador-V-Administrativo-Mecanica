...
export default function Caixa() {
  ...
  useEffect(() => {
    axios.get("https://projeto-integrador-v-administrativo.onrender.com/clientes").then((res) => setClientes(res.data));
    axios.get("https://projeto-integrador-v-administrativo.onrender.com/ordemDeServico").then((res) => setOrdens(res.data));
